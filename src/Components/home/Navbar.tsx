...
const Navbar: React.FC = () => {
  ...
  return (
    <div   
      className={`fixed h-14 top-4 left-1/2 transform -translate-x-1/2 backdrop-blur-xs pl-10  transition-all duration-400 ease-in-out flex  items-center    text-[#5e5e5e] dark:text-[#c2c2c2]    z-50 ${
