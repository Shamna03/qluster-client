          ...
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              <div className="relative p-6 flex flex-col items-center text-center text-white h-full">
                <div className={`p-3 rounded-full bg-gradient-to-r ${method.color} mb-4 shadow-lg`}>
                  {method.icon}
                </div>
                <h3 className="text-lg font-semibold mb-2">{method.title}</h3>
                <p className="font-medium mb-1">{method.value}</p>
                {method.subtext && <p className="text-xs opacity-80">{method.subtext}</p>}
            ...
            <Card className="overflow-hidden border-purple-200 dark:border-purple-900/50 shadow-xl rounded-xl backdrop-blur-sm bg-white/70 dark:bg-gray-900/70">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-2xl font-semibold text-[#611f69] dark:text-purple-300">Send us a message</h2>
                </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center border-b border-purple-100 dark:border-purple-900/30 pb-3">
                      ...
                      <span className="bg-purple-100 dark:bg-purple-900/30 text-[#611f69] dark:text-purple-300 px-3 py-1 rounded-full text-sm">9:00 AM - 5:00 PM</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-purple-100 dark:border-purple-900/30 pb-3">
                      <span className="font-medium">Saturday</span>
                      <span className="bg-purple-100 dark:bg-purple-900/30 text-[#611f69] dark:text-purple-300 px-3 py-1 rounded-full text-sm">10:00 AM - 2:00 PM</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-medium">Sunday</span>
                      <span className="bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-3 py-1 rounded-full text-sm">Closed</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <a href="#" className="group">
                      <div className="border border-purple-200 dark:border-purple-900/50 rounded-lg p-4 flex flex-col items-center justify-center text-center h-24 transition-all duration-300 hover:bg-purple-100/50 dark:hover:bg-purple-900/20 hover:border-[#611f69]">
                        ...
                        <span className="text-sm font-medium text-[#611f69] dark:text-purple-300">Facebook</span>
                      </div>
                    </a>
                    <a href="#" className="group">
                      <div className="border border-purple-200 dark:border-purple-900/50 rounded-lg p-4 flex flex-col items-center justify-center text-center h-24 transition-all duration-300 hover:bg-purple-100/50 dark:hover:bg-purple-900/20 hover:border-[#611f69]">
                        <X className="h-6 w-6 text-[#611f69] dark:text-purple-300 mb-2" />
                        <span className="text-sm font-medium text-[#611f69] dark:text-purple-300">Twitter</span>
                      </div>
                    </a>
                    <a href="#" className="group">
                      <div className="border border-purple-200 dark:border-purple-900/50 rounded-lg p-4 flex flex-col items-center justify-center text-center h-24 transition-all duration-300 hover:bg-purple-100/50 dark:hover:bg-purple-900/20 hover:border-[#611f69]">
                        <Instagram className="h-6 w-6 text-[#611f69] dark:text-purple-300 mb-2" />
                        <span className="text-sm font-medium text-[#611f69] dark:text-purple-300">Instagram</span>
                      </div>
                    </a>
                    <a href="#" className="group">
                      <div className="border border-purple-200 dark:border-purple-900/50 rounded-lg p-4 flex flex-col items-center justify-center text-center h-24 transition-all duration-300 hover:bg-purple-100/50 dark:hover:bg-purple-900/20 hover:border-[#611f69]">
                        <Linkedin className="h-6 w-6 text-[#611f69] dark:text-purple-300 mb-2" />
                        <span className="text-sm font-medium text-[#611f69] dark:text-purple-300">LinkedIn</span>
                      </div>
                    </a>
                  </div>
                </CardContent>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <CardContent className="p-0">
                  ...
                  >
                    <span className="font-medium text-[#611f69] dark:text-purple-300">{faq.question}</span>
                    <div className={`p-2 rounded-full bg-purple-100 dark:bg-purple-900/30 transition-transform duration-200 ${expandedFaq === index ? "rotate-180" : ""}`}>
                      {expandedFaq === index ? (
            ...
            <CardContent className="p-8 md:p-12">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-muted-foreground mb-8">
                  Reach out today and discover how we can help transform your business.
                </p>
